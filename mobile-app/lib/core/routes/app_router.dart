...
import '../../features/farmer/screens/farmer_chatbot_screen.dart';
import '../../features/farmer/screens/farmer_msp_finance_screen.dart';
...
class AppRouter {
  ...
  static const String farmerChatbot = '/farmer-chatbot';
  static const String farmerMspFinance = '/farmer-msp-finance';
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case farmerChatbot:
        return _buildRoute(const FarmerChatbotScreen());

      case farmerMspFinance:
        return _buildRoute(const FarmerMspFinanceScreen());
