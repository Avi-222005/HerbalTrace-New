...
void main() async {
  ...
  // Try optional Firebase initialization without blocking core app
  try {
    await Firebase.initializeApp(
      options: DefaultFirebaseOptions.currentPlatform,
    );
  } catch (e) {
    print('Firebase optional init notice: $e');
  }

  // Initialize Hive for offline storage & JWT persistence
  ...
  // Developer mode check toggle - disabled for development & testing
  const bool kEnforceDeveloperModeCheck = false;

  if (kEnforceDeveloperModeCheck) {
